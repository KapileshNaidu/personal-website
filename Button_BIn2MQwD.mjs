import { b as createAstro, c as createComponent, m as maybeRenderHead, d as addAttribute, e as renderSlot, a as renderTemplate } from './astro/server_D_CmcNH8.mjs';
import 'kleur/colors';
import 'clsx';
...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  const variants = {
    ...
    outline: "border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-gray-500"
  };
  const sizes = {
  ...
  const classes = `inline-flex items-center justify-center font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 ${variants[variant]} ${sizes[size]} ${className}`;
